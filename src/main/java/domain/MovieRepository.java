...
public class MovieRepository {
	...
	public static void makeListToMap(Map<Integer,Movie> map) {
		for (Movie movie : movies) map.put(movie.getId(),movie);
	}

	public static Movie getSelectedMovies(int movieId) {
